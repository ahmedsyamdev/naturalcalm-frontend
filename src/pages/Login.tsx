...
const Login = () => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'facebook' | 'apple') => {
    toast.info(`تسجيل الدخول عبر ${provider === 'google' ? 'جوجل' : provider === 'facebook' ? 'فيسبوك' : 'آبل'} قريباً`);
  };
          ...
          <div className="w-full px-6 space-y-6">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                disabled={isLoading}
                className="w-14 h-14 rounded-full bg-white border border-border shadow-sm flex items-center justify-center hover:shadow-md transition-shadow disabled:opacity-50"
              >
                <Apple size={24} />
              </button>
              <button
